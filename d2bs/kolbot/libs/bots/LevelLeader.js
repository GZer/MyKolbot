...
function LevelLeader(){
	...
	this.CheckQuests=function(ClearedArea){
		...
		switch(ClearedArea){
			...
			case 54://Summoner
				try{
					if(Pather.moveToExit(74,true,true)){Pather.makePortal();}
				}catch(err){Pather.journeyTo(74);Pather.makePortal();}
				Pather.getWP(74);
